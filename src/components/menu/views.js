       ...
       if(this.props.data.items){
           ...
           if(len){
               ...
               items=this.props.data.items.map(function (item) {
                   return <li onClick={that.onClick} key={item.id} className={currentId===item.id?"menu-item menu-item-on":"menu-item"} data-id={item.id}>
                       <Link className="db" to={"/tab/"+item.id}>{item.name}</Link>
                   </li>
               })
           }else{
               items=list
        ...
        return (
            <div className="pr menu-wrap">
                <div className="pf menu-pf">
                    <ul className="empty-loading menu" >
                        {items}
                    </ul>
                </div>
            </div>
